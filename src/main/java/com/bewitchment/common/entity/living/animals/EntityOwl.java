...
//ENTITYFAMILIAR
public class EntityOwl extends EntityMultiSkin implements IAnimatedEntity {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(4, new EntityAITargetNonTamed<EntityLivingBase>(this, EntityLivingBase.class, false, e -> e instanceof EntityRabbit || e instanceof EntityBat || e instanceof EntityChicken || e instanceof EntityParrot || e instanceof EntityBlindworm || e instanceof EntityLizard || e.getClass().getName().equals("seraphaestus.historicizedmedicine.Mob.Rat.EntityRat") || e.getClass().getName().equals("com.github.alexthe666.rats.server.entity.EntityRat")));
